    ...
    <>
      ...
      {isOpen && (
        <div
          ...
          role="dialog"
          aria-label="Finance AI assistant"
          aria-modal="false"
        >
          {/* Header */}
              ...
              <div className="flex flex-col h-full px-4 pt-4">
                ...
                <div className="mb-5">
                  ...
                  <p className="text-sm font-semibold text-foreground mb-1">
                    Ask anything about quant finance
                  </p>
                  <p className="text-xs text-muted leading-relaxed">
                    Cointegration, pairs trading, time series analysis, risk
                    models — grounded in the knowledge base.
                  </p>
                </div>
